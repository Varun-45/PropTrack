...
const {homecontroller, registeruser, loginuser, logoutuser, admin, forgotpass, resetpass, getuserdetails, updatepassword, updateprofile, getsingleuser, getallusers,  updateuserprofile, deleteuserprofile, usersaveproperty} = require('../Controllers/usercontroller');
...
router.put('/save/:productid',authuser,usersaveproperty)
